...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser('Training Vision Transformers for Image Retrieval', parents=[parent_parser])
...
# def get_args_parser():
#     parser = argparse.ArgumentParser('Training Vision Transformers for Image Retrieval', add_help=True)
